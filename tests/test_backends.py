...
def test_claude_code_writes_prompt_and_raises_pending(tmp_path):
    ...
    with pytest.raises(backends.PendingHandoff):
        backend.complete("SYS", "USER", tag="novel/ch0001/translate")

    prompt_file = tmp_path / "runs" / "novel" / "ch0001" / "translate.prompt.md"
...
def test_claude_code_consumes_existing_response(tmp_path):
    ...
    response_file = tmp_path / "runs" / "novel" / "ch0001" / "translate.response.md"
